  ...
  return (
    <>
      ...
      <div
        ...
        style={{
          transform: menu === true ? "translateX(0)" : "translateX(-100%)",
        }}
      >
        <div className="responsiveMenuItmesDiv">
          <div className="navTitle menuNavTitle">
            Ashish
            <AiOutlineClose
          ...
          <ul className="menuNavItems">
            ...
            <li>
              ...
              >
                <MdWork className="menuBarIcons" /> Work
              </a>
            </li>
            <li>
              <a
              ...
              >
                <AiFillContacts className="menuBarIcons" />
                Contact
              </a>
            </li>
          </ul>
